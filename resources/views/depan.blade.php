...
<head>
    ...
    <title>M Zein Farhan Nugraha - Portfolio</title>
    <!-- Favicon-->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">M Zein Farhan Nugraha</a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">M Zein Farhan Nugraha</h1>
            <!-- Icon Divider-->
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Copyright &copy; M Zein Farhan Nugraha 2023</small></div>
    </div>
    <!-- Partner Modals-->
    <!-- Partner Modal 1-->
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Partner Modal - Text-->
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recus